        ...
        $('table')
            ...
            .delegate('td', 'click', function() {
                ...
                if (lastColumnIndex > 0) {
                    $(
                        'tbody tr td:nth-child(' + lastColumnIndex + ')',
                        table
                    ).removeClass('SelectedColumn');
                    $(
                        'thead tr th:nth-child(' + lastColumnIndex + ')',
                        table
                    ).removeClass('SelectedColumn');
                }
                ...
                $(
                    'tbody tr td:nth-child(' + currentColumnIndex + ')',
                    table
                ).addClass('SelectedColumn');
                $(
                    'thead tr th:nth-child(' + currentColumnIndex + ')',
                    table
                ).addClass('SelectedColumn');
